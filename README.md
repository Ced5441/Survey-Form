...
**Objective:** Build a CodePen.io app that is functionally similar to this: [https://survey-form.freecodecamp.rocks](https://survey-form.freecodecamp.rocks).
...
16. User Story #16: Inside the form element, I am presented with a button with id="submit" to submit all my inputs.ts.
